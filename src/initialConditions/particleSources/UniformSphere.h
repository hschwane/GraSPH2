 ...
 *
 */
class UniformSphere : public ParticleSource<Particle<PS_DEFAULT_PARTICLE_BASES, DENSITY>>
{
public:
...
private:
    Particle<PS_DEFAULT_PARTICLE_BASES, DENSITY> generateParticle(size_t id) override;
