...
bool handleFrontend(double dt); //!< allow the frontend to do all its regular tasks. call in the main loop. returns false if the app was terminated by the user
